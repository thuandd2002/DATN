                            ...
                            <table style="font-size:14px;line-height:20px" width="100%">
                                ...
                                <tr>
                                    <td style="color:#5b5b5c;font-size:14px;padding: 15px 0;border-top: 1px solid #f3f3f3;" width="98%">
                                        ...
                                        <p> Yêu cầu xuất xe cho khách hàng của bạn đã được duyệt :  </p>
                                        <ul>
                                          
                                            <li>Ô tô : {{$orderInfo->product->pro_name}}</li>
                                            <li>Tên khách hàng : {{$orderInfo->user->name}}</li>
                                            <li>Email : {{$orderInfo->user->email}}</li>
                                            <li>SDT : {{$orderInfo->user->phone}}</li>
                                        </ul>
                                        <p>Xin cảm ơn !</p>
                                    </td>
